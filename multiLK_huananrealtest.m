...
variable_realization = length(huanan_SM(1,:));
for r=1:variable_realization
    [T21(:,r),err90(:,r),err95(:,r),err99(:,r)] = multiLK_code(MAlen_shuru ,NN_shuru,MA_shuru,np_shuru,huanan_GPP(:,r),huanan_SM(:,r),huanan_VPD(:,r));
    disp(num2str(r))
end
